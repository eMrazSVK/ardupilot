...
const AP_Param::GroupInfo AP_SerialManager::var_info[] = {
    ...
    // @Values: -1:None, 1:MAVLink1, 2:MAVLink2, 3:Frsky D, 4:Frsky SPort, 5:GPS, 7:Alexmos Gimbal Serial, 8:SToRM32 Gimbal Serial, 9:Lidar, 10:FrSky SPort Passthrough (OpenTX), 11:Lidar360, 12:Aerotenna uLanding, 13:Beacon, 14:ADB Protocol
    // @User: Standard
    // @RebootRequired: True
        ...
        if (state[i].uart != nullptr) {
            switch (state[i].protocol) {
                ...
                case SerialProtocol_ADB_Proto:
                    ...
                    //state[i].uart->begin(AP_SERIALMANAGER_ADB_Proto_BAUD,
                    //                     AP_SERIALMANAGER_ADB_Proto_BUFSIZE_RX,
                    //                     AP_SERIALMANAGER_ADB_Proto_BUFSIZE_TX);
                    break;
